...
# Save the figure
fig.savefig("reconstruction_separated_rmse_train_trajectory_without_scaler.png")
print("Comparison plot saved as 'reconstruction_separated_rmse_train_trajectory_without_scaler.png'")