...
# Prepare input tensor (Batch=1, Channels=3, Length=50)
# Slice trajectory to random length for testing
length = np.random.randint(5, 51)
print(f"Testing with trajectory length: {length}")

sub_traj = traj_sample[:length]
padded_traj = np.zeros((50, 2))
