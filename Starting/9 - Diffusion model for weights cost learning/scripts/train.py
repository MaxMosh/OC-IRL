...
# Input is (N, 50, 2) -> We transpose to (N, 2, 50)
w_tensor = torch.FloatTensor(w_data_normalized)
traj_tensor = torch.FloatTensor(traj_data).transpose(1, 2)

dataset = TensorDataset(traj_tensor, w_tensor)
