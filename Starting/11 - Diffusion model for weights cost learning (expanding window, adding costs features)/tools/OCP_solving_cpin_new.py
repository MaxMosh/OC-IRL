...
def plot_trajectory_q1(results_angles_cpin, results_vitesses_angulaires_cpin, linestyle = '-'):
    ...
    plt.savefig(f"plots/q1_values_{number_of_trajectories}_trajectories_lim_joint_velocities_{dq_max_lim_deg_par_s}.png")
    plt.show()
...
def plot_trajectory_q2(results_angles_cpin, results_vitesses_angulaires_cpin, linestyle = '-'):
    ...
    plt.savefig(f"plots/q2_values_{number_of_trajectories}_trajectories_lim_joint_velocities_{dq_max_lim_deg_par_s}.png")
    plt.show()
...
def plot_trajectory_dq1(results_angles_cpin, results_vitesses_angulaires_cpin, linestyle = '-'):
    ...
    plt.savefig(f"plots/dq1_values_{number_of_trajectories}_trajectories_lim_joint_velocities_{dq_max_lim_deg_par_s}.png")
    plt.show()
...
def plot_trajectory_dq2(results_angles_cpin, results_vitesses_angulaires_cpin, linestyle = '-'):
    ...
    plt.savefig(f"plots/dq2_values_{number_of_trajectories}_trajectories_lim_joint_velocities_{dq_max_lim_deg_par_s}.png")
    plt.show()