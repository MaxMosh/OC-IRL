...
TIMESTEPS = 1000
N_SAMPLES_DIFFUSION = 50  # 50 samples for good histogram resolution
W_DIM = 15 
INPUT_CHANNELS = 4
...
def main():
    ...
    def update(frame):
        ...
        for r in range(3): 
            # Progress Bar (Still useful context)
            ...
            for c in range(5): 
                ...
                # Always plot the histogram, regardless of phase progress
                # Using a slightly different color if the phase hasn't started yet?
                # Let's keep it uniform to show the prediction stability
                hist_color = 'orange'
