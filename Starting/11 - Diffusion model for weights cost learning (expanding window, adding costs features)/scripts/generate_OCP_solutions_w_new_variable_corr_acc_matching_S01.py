...
from tools.OCP_solving_cpin_new_variable_corr_acc_matching_S01 import solve_DOC
from tools.OCP_solving_cpin_new_variable_corr_acc_matching_S01 import plot_trajectory_q1, plot_trajectory_q2, plot_trajectory_ee
...
from tools.OCP_solving_cpin_new_variable_corr_acc_matching_S01 import L_1, L_2
# X_FIN_BASE = 1.9
X_FIN_BASE = (L_1 + L_2)*0.95
...
if __name__ == "__main__":
    ...
    suffix = f"parallel_{valid_count}_samples_WITH_ACC_matching_S01"
