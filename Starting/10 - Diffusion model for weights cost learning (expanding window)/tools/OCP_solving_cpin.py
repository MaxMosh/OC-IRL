...
def cost_function_value(q_var, dq_var):
    ...
    return f_10, f_11, f_2                                    # MODIF: uncomment and comment next
    # return f_10, f_11
...
def solve_DOC(w, x_fin = -0.75, q_init = [0, ca.pi/4]):
    ...
    J_10, J_11, J_2 = cost_function_value(q, dq)              # MODIF: uncomment and comment next
    ...
    opti.subject_to(opti.bounded(-1e-2, q[0, 0], 3*ca.pi/4))
