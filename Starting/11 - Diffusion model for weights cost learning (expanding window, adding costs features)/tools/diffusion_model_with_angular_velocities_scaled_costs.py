...
class TrajectoryEncoder(nn.Module):
    ...
    def forward(self, x):
        # Expects input shape: (Batch, input_channels, Sequence_Length)
        return self.net(x)
...
class DenoisingNetwork(nn.Module):
    ...
    Note: The output is NOT constrained to the simplex. 
    It predicts noise in the normalized space. Post-processing (inverse scaling + projection)
    is required during sampling.
    """
