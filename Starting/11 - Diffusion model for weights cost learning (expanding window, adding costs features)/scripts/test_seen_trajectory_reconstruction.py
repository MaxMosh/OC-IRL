...
# Picking ground truth weights (train data)
print("Generating Ground Truth trajectory...")

array_w = np.load("data/array_w_10000.npy")
number_of_w = array_w.shape[0]
random_index = np.random.randint(0,number_of_w)
w_true = array_w[random_index,:]
...
#  Helper: Calculate RMSE in degrees 
...
# Add RMSE text box in bottom right
...
# Save the figure
fig.savefig("reconstruction_separated_rmse_train_trajectory.png")
print("Comparison plot saved as 'reconstruction_separated_rmse_train_trajectory.png'")