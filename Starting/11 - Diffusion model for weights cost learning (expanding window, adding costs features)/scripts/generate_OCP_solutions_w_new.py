...
from tools.OCP_solving_cpin_new import dq_max_lim_deg_par_s
from tools.OCP_solving_cpin_new import generate_DOC_solutions_list_w
from tools.OCP_solving_cpin_new import plot_trajectory_q1, plot_trajectory_q2
from tools.OCP_solving_cpin_new import plot_trajectory_dq1, plot_trajectory_dq2
